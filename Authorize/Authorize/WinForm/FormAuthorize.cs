...
using FZFarm.AuthorizeCore.Interface;
using FZFarm.AuthorizeCore.Service;
using LoginFailedException = FZFarm.AuthorizeCore.CustomExceptions.LoginFailedException;

namespace FZFarm.Authorize.WinForm
{
    public partial class FormAuthorize : Form
    {
        ...
        private void CBCurrentUserLogin_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                throw new CustomException("У вас немає дозволу на використання, зверніться до адміністратора");
            }
        }
    }
}
